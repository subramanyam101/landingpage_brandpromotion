...
const serviceData = [
  ...
  },
  {
    ...
    icon: assets.content_icon, // closest match
  },
  {
    title: "Marketing",
    description:
  ...
  return (
    <div id="services" className="reltive flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white">
     
        <img src={assets.bgImage2} alt="bg_image"  className="absolute -top-110 -left-70 -z-1 dark:hidden"/>
